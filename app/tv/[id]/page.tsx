...
export default async function TVDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-[#070b14] text-white p-4 sm:p-6 pt-8 max-w-7xl mx-auto selection:bg-sky-500 selection:text-white pb-20">
      ...
      <Link 
        href="/" 
        className="inline-flex items-center gap-2 text-slate-400 hover:text-sky-400 mb-6 transition-colors font-semibold text-xs sm:text-sm bg-slate-900/80 px-3.5 py-2 rounded-xl border border-slate-800 w-fit"
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          {/* 2. Kotak Series Populer Lainnya (WIDGET BARU) */}
